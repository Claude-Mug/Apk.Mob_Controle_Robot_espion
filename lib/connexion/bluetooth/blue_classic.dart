...
Future<bool> isBluetoothEnabled() async {
  ...
  // Dans BluetoothClassicManager
Future<void> openBluetoothSettings() async {
    // Cela affiche la boîte de dialogue demandant d'activer le Bluetooth
    await setEnable(true); 
    // Si l'utilisateur clique sur 'Non', on peut alternativement
    // ouvrir les paramètres complets du téléphone :
     await openAppSettings(); // Nécessite l'importation de 'permission_handler'
}

// blue_classic.dart

// ... (Dans la classe BluetoothClassicManager)

/// Affiche une boîte de dialogue pour demander à l'utilisateur d'activer le Bluetooth.
Future<void> requestBluetoothEnable() async {
  // Ceci est l'API de flutter_bluetooth_serial pour demander l'activation.
  await _bluetooth.requestEnable();
}
